...
package edu.gatech.wguo64.lostandfoundandroidapp.notification;
...
public class RegistrationIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            // are local.
            // R.string.gcm_defaultSenderId (the Sender ID) is typically
            // derived from google-services.json.
            // See https://developers.google
            // .com/cloud-messaging/android/start for details on this file.
            // [START get_token]
            InstanceID instanceID = InstanceID.getInstance(this);
            String token = instanceID.getToken(getString(R.string
                            .gcm_defaultSenderId),
