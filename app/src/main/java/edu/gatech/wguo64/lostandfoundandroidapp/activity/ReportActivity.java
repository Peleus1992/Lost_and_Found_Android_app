 ...
 */
public class ReportActivity extends AppCompatActivity implements GoogleMap.OnMapLongClickListener,
        GoogleMap.OnMyLocationButtonClickListener, View.OnClickListener{

    public final static String TAG = ReportActivity.class.getName();
        ...
        switch (v.getId()) {
            ...
            case R.id.changePosBtn:
                try {
                    ...
                    e.printStackTrace();
                    Snackbar.make(ReportActivity.this.findViewById(R.id.coordinatorLayout)
            ...
            case R.id.doneBtn:
                if(!checkForm()) {
                    Snackbar.make(ReportActivity.this.findViewById(R.id.coordinatorLayout), "Please fill the blank above", Snackbar.LENGTH_SHORT)
                            .show();
                    return;
                }
                submitForm();
    ...
    private void inflateViews() {
        ...
        clearTagBtn = (Button)findViewById(R.id.clearTagBtn);
    ...
    private void setUI() {
        ...
        categories.add("Select a report type...");
        categories.add("Lost report");
        categories.add("Found report");
        ...
        //Tag
        tagContainerLayout.setTag(new ArrayList<String>());
        addTagBtn.setOnClickListener(this);
        clearTagBtn.setOnClickListener(this);
        //date time
        ...
        dateEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(ReportActivity.this, new
        ...
        timeEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Calendar calendar = Calendar.getInstance();
                new TimePickerDialog(ReportActivity.this, new
    ...
    private void submitForm() {
        ...
        report.setReportType(reportTypeSpinner.getSelectedItemPosition() == 1);
        ...
        if(!timeCheck.isChecked()) {
            report.setTime(new DateTime(datetime.getTimeInMillis()));
        }
        ...
        new AsyncTask<Drawable, Void, Void>() {
            ...
            protected Void doInBackground(Drawable...
                ...
                try {
                    ...
                    Api.getClient().report().insert(report)
                            .execute();
                } catch (IOException e) {
                    e.printStackTrace();
                } catch (Exception e) {
    ...
    public void startAddTagDialog() {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if(content.length() == 0) {
                    Toast.makeText(ReportActivity.this, "Tag should not be empty.", Toast.LENGTH_SHORT).show();
                    return;
                }
                tagList.add(content);
                tagContainerLayout.addTag(content);
            }
        });
